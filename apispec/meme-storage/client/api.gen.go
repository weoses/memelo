...
type ClientInterface interface {
	...
	// DeleteMeme request
	DeleteMeme(ctx context.Context, accountId AccountId, memeId MemeId, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) DeleteMeme(ctx context.Context, accountId AccountId, memeId MemeId, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteMemeRequest(c.Server, accountId, memeId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewDeleteMemeRequest generates requests for DeleteMeme
func NewDeleteMemeRequest(server string, accountId AccountId, memeId MemeId) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/accounts/%s/meme/%s", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// DeleteMemeWithResponse request
	DeleteMemeWithResponse(ctx context.Context, accountId AccountId, memeId MemeId, reqEditors ...RequestEditorFn) (*DeleteMemeResponse, error)
...
type SearchMemeResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *[]SearchMemeResponseItemDto
	JSON500      *ErrorResponseDto
}
...
// Status returns HTTPResponse.Status
func (r DeleteMemeResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r DeleteMemeResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// DeleteMemeWithResponse request returning *DeleteMemeResponse
func (c *ClientWithResponses) DeleteMemeWithResponse(ctx context.Context, accountId AccountId, memeId MemeId, reqEditors ...RequestEditorFn) (*DeleteMemeResponse, error) {
	rsp, err := c.DeleteMeme(ctx, accountId, memeId, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseDeleteMemeResponse(rsp)
}
...
func ParseSearchMemeResponse(rsp *http.Response) (*SearchMemeResponse, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest []SearchMemeResponseItemDto
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
...
// ParseDeleteMemeResponse parses an HTTP response from a DeleteMemeWithResponse call
func ParseDeleteMemeResponse(rsp *http.Response) (*DeleteMemeResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
