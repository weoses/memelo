...
func (s *CheckDuplicateByHashPipelineStep) Check(_ context.Context, steps *service.StepsToDo) (bool, error) {
	return steps.DuplicateSearch && steps.CalcHash, nil
}

func (s *CheckDuplicateByHashPipelineStep) Do(ctx context.Context, pCtx *service.PipelineContext) error {
