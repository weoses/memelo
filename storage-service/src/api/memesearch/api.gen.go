// Package memesearch provides primitives to interact with the openapi HTTP API.
//
...
type ServerInterface interface {
	...
	// (GET /api/v1/meme)
	SearchMeme(ctx echo.Context, params SearchMemeParams) error
}
...
func (w *ServerInterfaceWrapper) SearchMeme(ctx echo.Context) error {
	...
	err = w.Handler.SearchMeme(ctx, params)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/api/v1/meme", wrapper.SearchMeme)
...
type SearchMeme200JSONResponse []MemeDto
...
func (sh *strictHandler) SearchMeme(ctx echo.Context, params SearchMemeParams) error {
