...
export default function Dialog({ onClose, title, canClose = true, noHeader = false, children, className = '', onSwipeLeft, onSwipeRight }: Props) {
  ...
  return (
    <div
      ref={dragRef}
      className={`relative bg-[#141414] rounded-t-2xl sm:rounded-xl shadow-2xl ${className}`}
